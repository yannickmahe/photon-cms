CREATE TABLE page (id INTEGER PRIMARY KEY, title STRING, url STRING, head_html TEXT, body_html TEXT);
	INSERT INTO page (title, url, head_html, body_html) VALUES ('Home','/','','<h1>Homepage</h1>');
	...
	INSERT INTO page (title, url, head_html, body_html) VALUES ('About','/about','','<h1>About</h1>');
	INSERT INTO page (title, url, head_html, body_html) VALUES ('Portfolio','/portfolio','','<h1>Portfolio</h1>');
